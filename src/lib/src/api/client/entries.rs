...
async fn try_download_entry_chunk(
    ...
    try_download_entry_chunk_with_bearer_token(remote_repo, remote_path, local_path, revision, chunk_start, chunk_size, None).await
}
...
async fn download_entry_chunk(
    ...
    download_entry_chunk_with_bearer_token(remote_repo, remote_path, local_path, revision, chunk_start, chunk_size, None).await
}
